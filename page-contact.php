  ...
  while ( have_posts() ) :
    ...
    <section id="contact-main" class="w-full py-20">
      <div class="max-w-[1240px] mx-auto px-6 grid grid-cols-[1.1fr_0.9fr] gap-16 items-start">
        ...
        <div class="soft-shadow rounded-xl border border-slate-300 bg-white/95 p-8">
          <?php echo do_shortcode('[forminator_form id="213"]'); ?>
        </div>
        
        <aside class="space-y-6">
          <div class="rounded-xl border border-slate-300 bg-white/95 p-6 space-y-3">
          ...
          <div class="rounded-xl border border-slate-300 bg-white/95 p-6 space-y-2">
