  ...
  <div class="max-w-[1240px] mx-auto px-4 md:px-6 lg:px-8">
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="card space-y-4 text-neutral-700">
        ...
        <p>She is the author of the Medicinal Herb Handbook, a reference guide to herbal remedies organized by organ system and symptom. She has lectured at conferences across the country and internationally, including the Southwest Conference of Botanical Medicine, the American Herbalists Guild Symposium, the Florida Herbal Conference, and events in the United Kingdom.</p>
      </div>
      <div class="card space-y-4 text-neutral-700">
        <p>Her peers in the herbalism world -- people like David Winston, Roy Upton, Brigitte Mars, Rosita Arvigo, and Juliet Blankespoor -- know her as a colleague and a friend. She has been called "legendary" and "a national treasure" by people who have spent their own lifetimes in this work. That kind of respect isn't earned with titles. It's earned with decades of showing up.</p>
        <p>Earlier in her career, Feather co-instructed a three-year program at the Rocky Mountain Center for Botanical Studies in Boulder, Colorado, graduating over 400 students as trained Western herbalists. As a solo instructor through Canyon Spirit Ventures, she has trained roughly another thousand -- through apprenticeships, field studies, online courses, and symposiums. Many of her graduates have gone on to open their own herb schools and build thriving practices.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section bg-[var(--color-muted)]">
  <div class="max-w-[1240px] mx-auto px-4 md:px-6 lg:px-8">
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="card text-neutral-700">Feather, you are essentially my herb mama and I will forever be grateful for you.</div>
      <div class="card text-neutral-700">It's no exaggeration to say that it's positively changed how I see and experience the world around me, the plant world in particular.</div>
      <div class="card text-neutral-700">Her colleagues in the field -- David Winston, Brigitte Mars, Rosita Arvigo, Juliet Blankespoor -- know her as a friend and a peer. When her name comes up in the herbal community, the response is warm and immediate.</div>
    </div>
  </div>
</section>
    ...
    <div class="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
      <div>
        ...
        <div class="space-y-4 text-neutral-700">
          ...
          <p>For years, Feather called Sedona, Arizona home. The red rocks, the desert plants, and the sacred places of that landscape are woven into her teaching and her story. She now lives in Florida, but her connection to the land -- wherever she is -- remains the foundation of everything she does.</p>
          <p>When she's not teaching, you might find her playing flute in a canyon, sitting quietly with a medicine wheel, or simply walking among the plants she has known for a lifetime.</p>
        </div>
      </div>
      <div class="w-full">
...
<section class="section bg-[var(--color-muted)]">
  <div class="max-w-[1240px] mx-auto px-4 md:px-6 lg:px-8">
    ...
    <div class="mt-8 text-neutral-600">
      <p>Follow Feather's plant walks and herbal wisdom on social media, or join the mailing list for program updates and seasonal insights.</p>
    </div>
  </div>
</section>
