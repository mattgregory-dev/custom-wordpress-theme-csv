    ...
    <div class="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
      <div>
        ...
        <div class="flex flex-wrap gap-4">
          ...
          <a class="btn btn-secondary" href="#">Meet Feather &raquo;</a>
        </div>
      </div>
      <div class="w-full">
  ...
  <div class="container">
    ...
    <div class="grid grid-cols-1 gap-5 mt-11 min-[600px]:grid-cols-2 min-[900px]:grid-cols-4 reveal">
      ...
      <div class="route-card">
        ...
        <a href="#" class="btn btn-secondary">Learn About Group Classes</a>
      </div>
      <div class="route-card">
        ...
        <a href="#" class="btn btn-secondary">Explore Mentorship</a>
      </div>
      <div class="route-card">
        ...
        <a href="#" class="btn btn-secondary">See Field Trip Details</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="grid grid-cols-1 gap-12 items-center md:grid-cols-[1fr_2.2fr] md:gap-14">
      <div class="reveal">
        <div class="content-img">
          <img src="<?php echo get_template_directory_uri(); ?>/images/bg/2760649.webp" alt="" class="object-top">
        </div>
      </div>
      <div class="reveal">
        ...
        <a href="#" class="btn-ghost">Read Feather&rsquo;s Full Story &rarr;</a>
      </div>
    </div>
  </div>
</section>
...
<section class="section test-section">
  <div class="container reveal">
    ...
    <div style="margin-top:24px">
      <a href="#" class="btn-ghost">Read More Student Stories &rarr;</a>
    </div>
  </div>
</section>
