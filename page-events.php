...
<section class="section bg-[var(--color-muted)]">
  <div class="max-w-[1240px] mx-auto px-4 md:px-6 lg:px-8">
    ...
    <div class="space-y-4 text-neutral-700 max-w-4xl">
      ...
      <p>"Is this the right one? Am I harvesting it correctly? Am I taking too much?"</p>
      <p>Online courses can teach you concepts. They can't teach you how a leaf feels between your fingers. They can't show you where a plant chooses to grow -- and what that tells you about its medicine.</p>
      <p>That gap between knowing and doing is where confidence lives. And it's hard to close it alone, from behind a screen.</p>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="max-w-[1240px] mx-auto px-4 md:px-6 lg:px-8">
    ...
    <div class="space-y-4 text-neutral-700 max-w-4xl">
      ...
      <p>You won't just look at plants. You'll crouch beside them. Smell them. Learn to read the landscape they chose. Practice harvesting them with care and intention.</p>
      <p>Throughout the trip, you'll make real medicine with your own hands -- tinctures, salves, and preparations you can keep making in your own kitchen long after you leave.</p>
      ...
      <p>This is not a lecture series with a nice view. It's a practice. And you'll leave knowing how to keep practicing.</p>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="max-w-[1240px] mx-auto px-4 md:px-6 lg:px-8">
    ...
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="card text-neutral-700">I was nervous about camping and worried I didn't know enough. By day two, I forgot both of those concerns. The group was warm, the pace was gentle, and I learned more in four days than I did in a full year of online study.</div>
      <div class="card text-neutral-700">I've taken courses, read every book I could find, and watched hours of videos. Nothing compared to four days in the field with Feather. There is no substitute for being there.</div>
      <div class="card text-neutral-700">Testimonial names and locations to be updated with real participant details.</div>
    </div>
  </div>
</section>
